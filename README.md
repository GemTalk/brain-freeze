...
Turn it on in VS Code settings — `gemdb.mcp.enabled`, which defaults to
**false** — and the endpoint is `http://127.0.0.1:50390/mcp` (Streamable HTTP,
loopback, no auth) unless `gemdb.mcp.port` says otherwise.
